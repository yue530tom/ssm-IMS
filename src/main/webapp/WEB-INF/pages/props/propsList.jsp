            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    ...
                    <li>
                        ...
                        <ul class="nav sub">
                            <li><a href="/pros/toProsAddPage">新增属性<i class="ec-pencil2"></i> </a>
                            </li>
                            <li><a href="/pros/toProsListPage">维护属性<i class="im-checkbox-checked"></i></a>
                            </li>
                        </ul>
                    </li>
                </ul>
                                            ...
                                            <div id="instagram-widget" class="carousel slide">
                                                ...
                                                <div class="carousel-inner">
                                                    <figure class="item active">
                                                        <img class="img-responsive" src="/resources/assets/img/instagram/instagram.jpg" alt="image">
                                                    </figure>
                                                    <figure class="item">
                                                        <img class="img-responsive" src="/resources/assets/img/instagram/instagram2.jpg" alt="image">
                                                    </figure>
                                                    <figure class="item">
                                                        <img class="img-responsive" src="/resources/assets/img/instagram/instagram3.jpg" alt="image">
                                                    </figure>
                                                </div>
                                            </div>
                                            <!-- End Carousel -->
