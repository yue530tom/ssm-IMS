...
/* 	    		$(document).ajaxStart(
		...
		function refreshList(json){
			...
			for(var i = 0; i < ja.length; i++){
				...
				$("#tr_" + i).append('<td><a href="/props/delete/' + queryPropsId + '">修改</a><a href="/props/delete/' + queryPropsId + '">删除</a></td>');
			}
		...
		function doFilterQuery(){
			...
			alert("doFilterQuery:"+$("#buffer_span").text());
			initTable(JSON.stringify(filterJs));
		}
		function doFilterModify(){
			var filterJs = {};
			if ($("#modifyPropsId").val() != "") {
				filterJs["modifyPropsId"] = $("#modifyPropsId").val();
			}
			if ($("#modifyPropsName").val() != "") {
				filterJs["modifyPropsName"] = $("#modifyPropsName").val();
			}
			if ($("#modifyPropsDesc").val() != "") {
				filterJs["modifyPropsDesc"] = $("#modifyPropsDesc").val();
			}
			if ($("#modifyPropsRemarks").val() != "") {
				filterJs["modifyPropsRemarks"] = $("#modifyPropsRemarks").val();
			}
			alert(filterJs);
			$("#buffer_span").text(JSON.stringify(filterJs));
			initTable(JSON.stringify(filterJs));
		...
		function doFilterAdd(){
			var filterJs = {};
			if ($("#addPropsName").val() != "") {
				filterJs["addPropsName"] = $("#addPropsName").val();
			}
			if ($("#addPropsDesc").val() != "") {
				filterJs["addPropsDesc"] = $("#addPropsDesc").val();
			}
			if ($("#addPropsRemarks").val() != "") {
				filterJs["addPropsRemarks"] = $("#addPropsRemarks").val();
			}
			alert(filterJs);
			$("#buffer_span").text(JSON.stringify(filterJs));
			initTable(JSON.stringify(filterJs));
	...
	<div id="sidebar">
		...
		<div class="sidebar-inner">
			...
			<ul id="sideNav" class="nav nav-pills nav-stacked">
				...
				<li><a href="/userTest">控制面板 <i class="im-screen"></i></a></li>
				<li><a href="#">产品<i class="im-paragraph-justify"></i></a>
					<ul class="nav sub">
						<li><a href="/product/toProductAddPage">新增产品<i
								class="ec-pencil2"></i>
						</a></li>
						<li><a href="/product/toProductListPage">维护产品<i
								class="im-checkbox-checked"></i></a></li>
					</ul></li>
				<li><a href="#">订单<i class="im-paragraph-justify"></i></a>
					<ul class="nav sub">
				...
				<li><a href="#">工厂<i class="im-paragraph-justify"></i></a>
					<ul class="nav sub">
				...
				<li><a href="#">属性<i class="im-paragraph-justify"></i></a>
					<ul class="nav sub">
						<li><a href="/props/toPropsAddPage">新增属性<i
								class="ec-pencil2"></i>
						</a></li>
							...
							<div class="panel-body">
								<div class="form-horizontal hover-stripped">
									...
									<div class="form-group">
										...
										<div class="col-lg-9">
											<button id ="doAdd" class="btn btn-primary" onclick="doFilterAdd();">新增</button>
										</div>
									</div>
									<!-- End .form-group  -->
								</div>
							...
							<div class="panel-body">
								<div class="form-horizontal hover-stripped" >
									...
									<div class="form-group">
										<label class="col-lg-3 control-label"></label>
										<div class="col-lg-9">
											<button id ="doQuery" class="btn btn-primary" onclick="doFilterQuery();">查询</button>
										</div>
									</div>
									<!-- End .form-group  -->
								</div>
							...
							<div class="panel-body">
								<div class="form-horizontal hover-stripped" >
									...
									<div class="form-group">
										<label class="col-lg-3 control-label"></label>
										<div class="col-lg-9">
											<button id ="doModify" class="btn btn-primary" onclick="doFilterModify();">修改</button>
										</div>
									</div>
									<!-- End .form-group  -->
								</div>
